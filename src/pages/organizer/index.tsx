...
export default function OrganizerPage() {
    ...
    const matchSimple = matchPath<{ organizerId: string }>(location.pathname, {
        path: '/organizer/:organizerId',
        exact: true,
    });
    const organizerId = matchSimple?.params?.organizerId;
                            ...
                            <div className="flex items-center justify-between max-w-4xl mx-auto">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500">立即開啟APP，查看主辦詳情</p>
                                    </div>
                                </div>
                                <a
                                    href={getAppStoreUrl()}
                ...
                <main className="flex-grow py-12">
                    {organizerId ? (
                        ...
                        <div className="text-center py-20">
                            <h2 className="text-2xl font-bold text-gray-800">No Organizer ID provided</h2>
                            <p className="text-gray-600 mt-2">Please provide a valid organizer ID in the URL.</p>
                        </div>
                    )}
                </main>
