  ...
  return (
    <section className="py-24 bg-white" id="insights">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-4xl font-bold mb-12 text-gray-800">Unlock Unparalleled Insights with Weather Effect</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-16">
          ...
          <div className="pl-8">
            ...
            <a href="https://weathercalendar.meteosync.com/" className="inline-block bg-gradient-to-r from-[#116CB5] to-[#67C0DA] text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:-translate-y-1">Explore Weather Calendar</a>
          </div>
        </div>
      </div>
    </section>
