      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-16">
          ...
          <div className="pl-8">
            ...
            <a href="https://www.meteosync.com/calendar" className="inline-block bg-gradient-to-r from-[#116CB5] to-[#67C0DA] text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:-translate-y-1  mb-8">User Case: Weather Calendar</a>

            <a href="https://www.meteosync.com/trip-planner" className="inline-block bg-gradient-to-r from-[#116CB5] to-[#67C0DA] text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:-translate-y-1">User Case: WeatherGo Plan</a>
